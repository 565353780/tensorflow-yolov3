...
tf.app.flags.DEFINE_string(
    'input_img', 'E:/chLi/tensorflow-yolo-v3/01.jpg', 'Input image')
tf.app.flags.DEFINE_string(
    'output_img', 'E:/chLi/tensorflow-yolo-v3/01_out.jpg', 'Output image')
tf.app.flags.DEFINE_string(
    'class_names', 'E:/chLi/tensorflow-yolo-v3/coco.names', 'File with class names')
tf.app.flags.DEFINE_string(
    'weights_file', 'E:/chLi/tensorflow-yolo-v3/yolov3.weights', 'Binary file with detector weights')
tf.app.flags.DEFINE_string(
    'data_format', 'NCHW', 'Data format: NCHW (gpu only) / NHWC')
tf.app.flags.DEFINE_string(
    'ckpt_file', 'E:/chLi/tensorflow-yolo-v3/saved_model/model.ckpt', 'Checkpoint file')
tf.app.flags.DEFINE_string(
    'frozen_model', 'E:/chLi/tensorflow-yolo-v3/frozen_darknet_yolov3_model.pb', 'Frozen tensorflow protobuf model')
